...
def get_boxplot_outliers(
    ...
    # так понимаю key() сортирует массив, второй параметр отвечает сортировать по убыванию или по возрастанию
    data_sorted = key(data, True)
    # data_sorted = np.sort(data,order=key)
