...
- Студенты, сдавшие работу в срок, допусткаются к очной защите домашнего задания. Дата и время очной защиты устанавливается семинаристом заранее;
- Во время очной защиты студенту необходимо объяснить свои решения и ответить на дополнительные вопросы семинариста;
...
- Если работа не была сдана в момент проведения устной сдачи, работа считается незасчитанной и оценивается в 0 баллов;
