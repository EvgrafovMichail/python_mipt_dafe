...
def is_scolarship_correct(best_students: Iterable, active_students: Iterable,
                          delinquent_students: Iterable, lagging_students: Iterable,
                          all_students: Iterable, scolarships: Iterable) -> Iterable:
...
if __name__ == "__main__":
    is_scolarship_correct([1], [1], [1], [1], [1], [1])
